      ...
      <div className="m-auto">
        ...
        <div className="w-full pt-7">
          <div className="text-center w-64 sm:w-3/4 m-auto">
            <a
              href="#"
              className="bg-purpleCust py-3 px-10 m-8 block sm:inline text-white text-xl rounded-fh"
            >
              Buy House
            </a>
            <a
              href="#"
              className="bg-orangeCust py-3 px-10 m-8 block sm:inline text-white text-xl rounded-fh"
            >
              Sell House
            </a>
          </div>
